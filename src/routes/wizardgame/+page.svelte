<script lang="ts">
  ...
  import wizardgameplay from "$lib/assets/wizardtower1.jpg";
  import wizardendscreen from "$lib/assets/wizardtower2.jpg";

  const images = [wizardgameplay, wizardendscreen];
  ...
  <div class="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="mb-8">
      <div class="card bg-white shadow-md rounded-lg overflow-hidden">
        <div class="py-4 m-4 grid grid-cols-1 items-center">
        ...
        <div>
          ...
          <span class="flex-auto">
            ...
            <dd class="text-gray-300">
              Created the UI and layout for the HUD and Menu, ensuring a cohesive and appealing aesthetic.
            </dd>
          </span>
        </div>
        <div>
