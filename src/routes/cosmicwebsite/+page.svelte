        ...
        <div class="py-4 m-4 sm:m-8 grid grid-cols-1 items-center">
          <div class="relative inline-block">
            ...
            <div class="flex justify-center">
              ...
              <button
                type="button"
                class="btn-icon variant-soft-surface hover:bg-secondary-500 transition duration-300 absolute top-1/2 left-2 sm:left-8 z-10"
              ...
              <button
                type="button"
                class="btn-icon variant-soft-surface hover:bg-secondary-500 transition duration-300 ml-4 absolute top-1/2 right-2 sm:right-8 z-10"
