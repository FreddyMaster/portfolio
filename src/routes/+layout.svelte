...
<AppShell regionPage="scroll-smooth">
  <svelte:fragment slot="sidebarLeft">
    ...
    <nav class="list-nav h-full bg-surface-500/10 flex flex-col">
      ...
      <div class="flex mt-auto w-full justify-center gap-x-4 max-w-xl">
        <div class="pb-6">
          <a
            class="btn-icon btn-icon-lg variant-soft-primary"
        ...
        <div class="pb-6">
          <a
            class="btn-icon btn-icon-lg variant-soft-primary"
            href="https://www.linkedin.com/in/alexander-gervais-a1baa32a5/"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="2rem"
        ...
        <div class="pb-6">
          <a
            class="btn-icon btn-icon-lg variant-soft-primary"
            href="mailto:aj@gervaisunplugged.com"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="2em"
